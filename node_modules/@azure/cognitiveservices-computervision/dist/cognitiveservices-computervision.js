...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var BatchReadFileInStreamHeaders = {
    ...
    var Mappers = /*#__PURE__*/Object.freeze({
        ...
        BatchReadFileHeaders: BatchReadFileHeaders,
        RecognizeTextInStreamHeaders: RecognizeTextInStreamHeaders,
        BatchReadFileInStreamHeaders: BatchReadFileInStreamHeaders
    });
    ...
    var batchReadFileOperationSpec = {
        ...
        responses: {
            202: {
                headersMapper: BatchReadFileHeaders
            },
            default: {
                bodyMapper: ComputerVisionError
            }
    ...
    var batchReadFileInStreamOperationSpec = {
        ...
        responses: {
            202: {
                headersMapper: BatchReadFileInStreamHeaders
            },
            default: {
                bodyMapper: ComputerVisionError
            }
